...
<body class="theme-cyan login-page authentication">
	...
	<div class="container">
		...
		<div class="card">
			<h1 class="title"><span>Whitecliff Martenity and Clinic</span>Patient Login <span class="msg">Hello, Patient!</span></h1>
			<div class="col-md-12">
				...
				<form method="post" action="" name="frmadminlogin" id="sign_in" onSubmit="return validateform()">
					...
					<div>
						...
						<div class="text-center"> <a href="patient.php">Sign Up</a></div>
					</div>
				</form>
			</div>
		</div>
