...
?>			
        ...
        <tr>
          ...
          <td>
    		<?php
				$sqldoctor= "SELECT * FROM doctor INNER JOIN branch ON branch.branchid=doctor.branchid WHERE doctor.status='Active' AND doctor.doctorid='$_SESSION[doctorid]'";
				$qsqldoctor = mysqli_query($con,$sqldoctor);
				while($rsdoctor = mysqli_fetch_array($qsqldoctor))
				{
					echo "$rsdoctor[doctorname] ( $rsdoctor[branchname] )";
				}
				?>
