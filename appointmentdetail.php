...
if (isset($_POST['submitapp'])) {
	$sql = "INSERT INTO appointment(appointmenttype,roomid,branchid,appointmentdate,appointmenttime,doctorid) values('$_POST[select]','$_POST[select2]','$_POST[select3]','$_POST[date]','$_POST[time]','$_POST[select5]')";
